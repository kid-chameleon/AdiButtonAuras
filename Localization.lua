...
if locale == 'frFR' then
	...
	L["Check to show a border when the (de)buff is missing."] =
	"Cochez pour afficher un pourtour quand le (dé)buff est absent."                                                                                                                           -- Needs review
	...
	L["Durations above this threshold are hidden. Set to 0 to disable all countdowns."] =
	"Les durées au-dessus de ce seuil sont cachés. Choisissez 0 pour désactiver tous les comptes à rebours."                                                                                   -- Needs review
	L["Enabled"] = "Activé"
	...
	"Affiche le nombre de membres du groupe affecté par @NAME et sa durée la plus courte;"                                                                                                     -- Needs review
	L["Show when @NAME or an equivalent haste buff is found on yourself."] =
	"Affiche quand vous avez @NAME ou un buff de hâte équivalent."                                                                                                                             -- Needs review
	...
	L["%s when %s is casting/channeling a spell that you can interrupt."] =
	"%s quand %s lance un sort que vous pouvez interrompre."                                                                                                                                   -- Needs review
	...
	L["The color used for bad things, usually debuffs."] =
	"La couleur utilisée pour les mauvaises choses, généralement les débuffs."                                                                                                                 -- Needs review
	L["The color used for good things, usually buffs."] =
	"La couleur utilisée pour les bonnes choses, généralement les buffs."                                                                                                                      -- Needs review
...
elseif locale == 'esMX' then
	...
	L["Check to show a border when the (de)buff is missing."] =
	"Mostrar un borde cuando el beneficio o perjuicio se falta."
	L["combo points"] = "puntos de combo"
	L["darken"] = "oscurecerse"
	L["Disabled"] = "Desactivado"
	L["Durations above this threshold are hidden. Set to 0 to disable all countdowns."] =
	"Duraciones más de este umbral se ocultan. Establece a 0 para desactivar todos cooldowns."
	L["Enabled"] = "Activado"
	L["flash"] = "destello"
	L["Global"] = "Global"
	...
	L["Show the number of group member affected by @NAME and the shortest duration."] =
	"Mostrar el número del miembro del grupo quién está afectado por @NAME y la duración más corta."
	L["Show when @NAME or an equivalent haste buff is found on yourself."] =
	"Mostrar cuando @NAME o un beneficio equivalente se encuentra en ti mismo."
	L["solar energy"] = "energía solar"
	L["Spells & items"] = "Hechizos y objetos"
	L["stagger level"] = "nivel de Alpazar"
	L["Status"] = "Estado"
	L["%s when %s is casting/channeling a spell that you can interrupt."] =
	"%s cuando %s está lanzado o canalizando un hechizo que puedes interrumpir."
	...
	L["The color used for bad things, usually debuffs."] =
	"El color a utilizar para las cosas malas, en general perjuicios."
	L["The color used for good things, usually buffs."] =
	"El color a utilizar para las cosas malas, en general beneficios."
